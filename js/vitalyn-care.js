...
(function () {
  ...
  const ROLES = [
    { id: "patient", short: "PT", cap: "PATIENT", name: "Patient",
      ...
      tabs: ["device", "plan", "ai", "score", "passport", "meds", "sos", "reports"],
    ...
    { id: "doctor", short: "DR", cap: "DOCTOR", name: "Doctor",
      ...
      tabs: ["device", "plan", "ai", "score", "passport", "sos", "reports"],
    ...
    { id: "caregiver", short: "CG", cap: "CARER", name: "Caregiver",
      ...
      tabs: ["device", "plan", "ai", "passport", "meds", "sos", "reports"],
  ...
  const Shell = {
    ...
    mount() {
      ...
      const ALL_KEYS = ["device", "plan", "ai", "score", "passport", "meds", "sos", "reports"];
      ...
      const RENDER = { device: renderDevice, plan: renderPlan, ai: renderAI,
      ...
      [["device", "Wearable"], ["plan", "Care Plan"], ["ai", "AI Analysis"], ["score", "Health Score"],
